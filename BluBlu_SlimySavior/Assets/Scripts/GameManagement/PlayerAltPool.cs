 ...
 * Desc: Object pool for player alternate attack
...
public class PlayerAltPool : MonoBehaviour
{
    ...
    private static PlayerAltPool instance;
    public static PlayerAltPool Instance { get { return instance; } }
